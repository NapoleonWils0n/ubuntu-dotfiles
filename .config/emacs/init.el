...
(custom-set-variables
 ...
 '(package-selected-packages
   '(fd-dired marginalia orderless embark vertico vterm 0blayout all-the-icons multi-vterm yaml-mode doom-themes openwith hydra mpv csv-mode emmet-mode evil-surround evil-leader git-auto-commit-mode haskell-mode iedit ob-async ox-pandoc undo-tree which-key s))

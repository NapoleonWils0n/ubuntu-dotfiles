...
(custom-set-variables
 ...
 '(package-selected-packages
   '(nix-mode 0blayout all-the-icons annalist consult company compat csv-mode doom-themes doom-modeline ednc embark embark-consult emmet-mode epl evil-collection evil-leader evil-surround f fd-dired flycheck git-commit git-auto-commit-mode haskell-mode hydra iedit magit magit-section marginalia mpv multi-vterm ob-async openwith orderless ox-pandoc pkg-info rg s shrink-path transient undo-tree vertico vterm wgrep with-editor which-key yaml-mode))

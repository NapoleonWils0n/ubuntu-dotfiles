...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ob-nix 0blayout all-the-icons annalist csv-mode doom-themes ednc emmet-mode epl evil-collection evil-leader fd-dired flycheck git-auto-commit-mode haskell-mode hydra iedit mpv multi-vterm ob-async openwith ox-pandoc pkg-info rg s shrink-path undo-tree vertico vterm wgrep which-key yaml-mode))
